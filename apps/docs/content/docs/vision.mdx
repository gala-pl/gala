---
title: Vision, Goals & Principles
description: Why Gala exists and what it aims to be
---

> **Thesis:** The next generation of quantum software will be written by AI and software engineers, not
...
- Not a Rust eDSL (that was Option A; we chose the standalone track).
