...
description: The surface-language reference — lexical structure, grammar, types, effects, and worked examples
---

This is the surface-language reference: lexical structure, grammar, type notation, effects, and
worked examples. Semantics of the type system are detailed in [Type System](/docs/language-spec/type-system).
...
implicitly dropped, or used after being consumed. See [Type System](/docs/language-spec/type-system).
...
### A fair coin (crossing the boundary)
...
See [Toolchain & DX](/docs/guides/toolchain).
